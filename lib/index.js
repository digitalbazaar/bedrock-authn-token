 ...
 * @param {string} options.tokenId - The id of the token to get.
 *
 ...
 *
 * @returns {Promise} - A Promise that resolves to tokens.
 */
 ...
 * @param {string} options.tokenId - The id of the token to be removed.
 *
