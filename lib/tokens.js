...
async function _setupNonceToken({
  ...
  const {allTokens, tokens} = await getAll({accountId, email, type: 'nonce'});
  ...
  return {challenge, allTokens, tokens};
}
